...
public class UserProvidedPublicationExtendedSignatureInputHashRuleTest extends AbstractRuleTest {

    private Rule rule = new UserProvidedPublicationExtendedSignatureInputHashRule();
