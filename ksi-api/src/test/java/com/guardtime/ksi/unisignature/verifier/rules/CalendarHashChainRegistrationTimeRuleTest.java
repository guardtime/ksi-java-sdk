...
public class CalendarHashChainRegistrationTimeRuleTest extends AbstractRuleTest {

    private CalendarHashChainRegistrationTimeRule rule = new CalendarHashChainRegistrationTimeRule();
