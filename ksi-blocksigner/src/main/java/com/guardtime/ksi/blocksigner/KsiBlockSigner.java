...
public class KsiBlockSigner implements BlockSigner<List<KSISignature>> {
    ...
    /**
     * Creates a new instance of {@link KsiBlockSigner} with given {@link KSI}, {@link KSISignatureFactory}
     * and {@link HashAlgorithm}.
     */
    public KsiBlockSigner(KSI ksi, KSISignatureFactory signatureFactory, HashAlgorithm algorithm) {
        this(ksi, algorithm);
