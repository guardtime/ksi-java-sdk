...
/**
 * This exception will be thrown when file based in-memory KSI multi signature is invalid.
 */
public final class InvalidFileBasedMultiSignatureException extends KSIException {
    ...
    public InvalidFileBasedMultiSignatureException(String message, Throwable cause) {
        super(message, cause);
    }
}
