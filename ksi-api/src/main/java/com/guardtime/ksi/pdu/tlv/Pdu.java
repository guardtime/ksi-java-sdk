...
//        }
    ...
    private void readMac(TLVElement rootElement, byte[] loginKey) throws KSIException {
        ...
        if (lastChild != null && lastChild.getType() == MessageMac.ELEMENT_TYPE) {
            ...
            TLVElement errorElement = rootElement.getFirstChildElement(0x0203);
            if (errorElement != null) {
                throw new KSIException("Invalid KSI response. Error payload element is " + Base16.encode(errorElement.getEncoded()));
            }
