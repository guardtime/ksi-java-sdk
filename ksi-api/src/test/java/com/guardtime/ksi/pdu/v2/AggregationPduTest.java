...
//
//        AggregationRequestPduV2 aggregationPdu = new AggregationRequestPduV2(header, Arrays.asList(payload), HashAlgorithm.SHA2_256, CREDENTIALS.getLoginKey());
//        assertNotNull(aggregationPdu);
//
//        AggregationRequestPduV2 parsedPdu = new AggregationRequestPduV2(aggregationPdu.getRootElement(), CREDENTIALS.getLoginKey());
//
//        byte[] bytes = aggregationPdu.getRootElement().getEncoded();
        ...
        KSI ksi = new KSIBuilder().
                ...
                setPduFactory(new PduV2Factory()).
                build();
