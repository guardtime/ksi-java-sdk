...
public class UserProvidedPublicationTimeMatchesExtendedResponseRuleTest {

    private Rule rule = new UserProvidedPublicationTimeMatchesExtendedResponseRule();
    ...
    @Test
    public void testVerifyExtendedCalendarChainTimeDoesNotMatchesWithPublication_Ok() throws Exception {
