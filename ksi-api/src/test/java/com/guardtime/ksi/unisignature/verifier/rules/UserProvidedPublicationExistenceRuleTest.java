...
public class UserProvidedPublicationExistenceRuleTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(context.getUserProvidedPublication()).thenReturn(new PublicationData(new Date(), new DataHash(HashAlgorithm.SHA2_256, new byte[32])));
    }
    ...
    public void testUserPublicationDataDoesNotExist_Ok() throws Exception {
        Mockito.when(context.getUserProvidedPublication()).thenReturn(null);
        RuleResult result = rule.verify(context);
