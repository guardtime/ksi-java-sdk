...
public class CalendarHashChainAlgorithmDeprecatedRule extends BaseRule {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CalendarHashChainAlgorithmDeprecatedRule.class);

    public VerificationResultCode verifySignature(VerificationContext context) throws KSIException {
        CalendarHashChain calendarHashChain = context.getSignature().getCalendarHashChain();
        if (calendarHashChain == null || isAlgorithmsDeprecated(calendarHashChain)) {
