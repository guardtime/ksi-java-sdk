...
public class ExtensionServiceRequestTest extends AbstractCommonServiceTest {
    ...
    public void testNormalOperations_Ok() throws Exception {
        Mockito.when(mockedResponse.getResult()).thenReturn(Util.parseResponseTLV(Util.toByteArray(load("extension-response-sig-2014-04-30.1.ksig"))));
    ...
    public void testResponseFormatException() throws Exception {
        Mockito.when(mockedResponse.getResult()).thenReturn(Util.parseResponseTLV(Util.toByteArray(load("extension/extension-response-invalid.tlv"))));
        Mockito.when(mockedExtenderClient.extend(Mockito.any(InputStream.class))).thenReturn(mockedResponse);
        Mockito.when(ksiService.generateRandomId()).thenReturn(5546551786909961666L);
    ...
    public void testResponseInvalidHMAC_ThrowsInvalidMessageAuthenticationCodeException() throws Exception {
        Mockito.when(mockedResponse.getResult()).thenReturn(Util.parseResponseTLV(Util.toByteArray(load("extension/extension-response-invalid-hmac.tlv"))));
        Mockito.when(mockedExtenderClient.extend(Mockito.any(InputStream.class))).thenReturn(mockedResponse);
        Mockito.when(ksiService.generateRandomId()).thenReturn(5546551786909961666L);
    ...
    public void testRequestIdsMismatch() throws Exception {
        Mockito.when(mockedResponse.getResult()).thenReturn(Util.parseResponseTLV(Util.toByteArray(load("extension/extension-response-ok-request-id-4321.tlv"))));
        Mockito.when(mockedExtenderClient.extend(Mockito.any(InputStream.class))).thenReturn(mockedResponse);
        Mockito.when(ksiService.generateRandomId()).thenReturn(5546551786909961666L);
    ...
    public void testRequestResponseEmpty() throws Exception {
        Mockito.when(mockedResponse.getResult()).thenReturn(Util.parseResponseTLV(Util.toByteArray(load("extension/extension-response-missing-response-payload.tlv"))));
        Mockito.when(mockedExtenderClient.extend(Mockito.any(InputStream.class))).thenReturn(mockedResponse);
        Mockito.when(ksiService.generateRandomId()).thenReturn(5546551786909961666L);
    ...
    public void testRequest404ErrorWithResponse() throws Exception {
        Mockito.when(mockedResponse.getResult()).thenReturn(Util.parseResponseTLV(Util.toByteArray(load("extension/extension-response-with-error-payload.tlv"))));
        Mockito.when(mockedExtenderClient.extend(Mockito.any(InputStream.class))).thenReturn(mockedResponse);
    ...
    public void testResponseWithError() throws Exception {
        Mockito.when(mockedResponse.getResult()).thenReturn(Util.parseResponseTLV(Util.toByteArray(load("extension/extension-error-response-with-header.tlv"))));
        Mockito.when(mockedExtenderClient.extend(Mockito.any(InputStream.class))).thenReturn(mockedResponse);
        Mockito.when(ksiService.generateRandomId()).thenReturn(5546551786909961666L);
